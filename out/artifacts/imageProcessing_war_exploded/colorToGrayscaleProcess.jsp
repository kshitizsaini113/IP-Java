...
<%!
    public void readImage() throws IOException
    {
        ...
        String path = "/home/kshitizsaini113/repo/imageProcessing/web/input/" + inputFileName + ".jpg";
...
<%!
    ...
    {
            outputFile = new File("/home/kshitizsaini113/repo/imageProcessing/web/output/Gray.jpg");
...
<%
    inputFileName = request.getParameter("name").toString();
    readImage();
    getPixels();
    convertToGrayscale();
    writeImage();
